                  ...
                  <tbody>
                    ...
                    >
                      <td>
                        <i className="fa-regular fa-scissors me-2" />
                        <small style={{ fontWeight: 500, letterSpacing: "0.5px" }}>
                          Gray hair toning / Fade The Gray
                        </small>
                      </td>
                      <td>
                    ...
                    {/* <tr>
                              <td>
                                  <i class="fa-regular fa-scissors me-2"></i>
                                  <small style="font-weight: 500; letter-spacing: 0.5px;">
                                      Plauke Plovimas su masazu / Mini-body Hair Washing Massage
                                  </small>
                              </td>
                              <td>
                                  <small style="font-weight: 400; letter-spacing: 0.5px;">30 min</small>
                              </td>
                              <td class="text-end">
                                  <small style="font-weight: 400; letter-spacing: 0.5px;">24,99$</small>
                              </td>
                          </tr> */}
                  </tbody>
                </table>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <i className="fa-regular fa-scissors me-2" />
                        <small style={{ fontWeight: 500, letterSpacing: "0.5px" }}>
                          Hair washing with massage / Mini-Body Hair Washing Massage
                        </small>
                      </td>
                      <td>
                        <small style={{ fontWeight: 400, letterSpacing: "0.5px" }}>
                  ...
                  <tbody>
                    <tr scope="col" style={{ cursor: "pointer" }}>
                      <td>
                        <i className="fa-regular fa-scissors me-2" />
                        <small style={{ fontWeight: 500, letterSpacing: "0.5px" }}>
                          Men's ear depilation / Ear Candle Wax
                        </small>
                      </td>
                      <td>
                        <small style={{ fontWeight: 400, letterSpacing: "0.5px" }}>
